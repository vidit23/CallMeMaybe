    ...
    return function (e) {
        ...
        var o = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (e) {
            ...
            p = function () {
                var e = window.RTCPeerConnection || window.mozRTCPeerConnection || window.webkitRTCPeerConnection,
                    ...
                    i = !!e && !!t && !!n,
                    r = !1;
                return c.default.debug(s.getBrowserInfo(), "isAPISupport:" + i), s.isChrome() && s.getBrowserVersion() >= 58 && "iOS" !== s.getBrowserOS() && (r = !0), s.isFireFox() && s.getBrowserVersion() >= 56 && (r = !0), s.isOpera() && s.getBrowserVersion() >= 45 && (r = !0), s.isSafari() && s.getBrowserVersion() >= 11 && (r = !0), (s.isWeChatBrowser() || s.isQQBrowser()) && "iOS" !== s.getBrowserOS() && (r = !0), s.isSupportedPC() || s.isSupportedMobile() || (r = !1), i && r
            },
            f = function () {
                var e = arguments[0];
        ...
        var r = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (e) {
            ...
            g = function (e) {
                ...
                if (i.params = Object.assign({}, e), i.stream = e.stream, i.aux_stream = void 0, i.url = e.url, i.onClose = void 0, i.local = !1, i.video = !!e.video, i.audio = !!e.audio, i.screen = !!e.screen, i.screenAttributes = {
                        width: 1920,
                        height: 1080,
                        maxFr: 5,
                        minFr: 1
                    }, i.videoSize = e.videoSize, i.player = void 0, i.audioLevelHelper = null, e.attributes = e.attributes || {}, i.videoEnabled = !0, i.audioEnabled = !0, i.lowStream = null, i.videoWidth = 0, i.videoHeight = 0, i.streamId = null, i.streamId = e.streamID, i.mirror = !1 !== e.mirror, !(void 0 === i.videoSize || i.videoSize instanceof Array && 4 === i.videoSize.length)) throw Error("Invalid Video Size");
                ...
                return i.unmuteAudio = void 0, i.muteAudio = void 0, i.unmuteVideo = void 0, i.muteVideo = void 0, i.setVideoResolution = function (t) {
                    ...
                    return !(0, l.isFireFox)() && ("object" === (void 0 === t ? "undefined" : r(t)) && t instanceof Array && t.length > 1 && (e.attributes = e.attributes || {}, e.attributes.minFrameRate = t[0], e.attributes.maxFrameRate = t[1], !0))
                }, i.setVideoBitRate = function (t) {
                    return "object" === (void 0 === t ? "undefined" : r(t)) && t instanceof Array && t.length > 1 && (e.attributes = e.attributes || {}, e.attributes.minVideoBW = t[0], e.attributes.maxVideoBW = t[1], !0)
                    ...
                    if (void 0 === a && (a = 2), !0 === i.initialized) return void("function" == typeof o && o({
                        type: "warning",
                        msg: "STREAM_ALREADY_INITIALIZED"
                    }));
                    if (!0 !== i.local) return void("function" == typeof o && o({
                        type: "warning",
                        ...
                        if ((e.audio || e.video || e.screen) && void 0 === e.url) {
                            ...
                            if (e.screen) var c = {
                                ...
                                if (!t()) {
                                    var p = 30,
                                        m = 30;
                                    if (void 0 !== e.attributes.minFrameRate && (p = e.attributes.minFrameRate), void 0 !== e.attributes.maxFrameRate && (m = e.attributes.maxFrameRate), !0 === c.audio && (c.audio = !e.microphoneId || {
                                            deviceId: {
                                                exact: e.microphoneId
                                            }
                                        }, i.audioProcessing)) {
                                        var g = {};
                                        void 0 !== i.audioProcessing.AGC && ((0, l.isFireFox)() ? g.autoGainControl = i.audioProcessing.AGC : (0, l.isChrome)() && (g.googAutoGainControl = i.audioProcessing.AGC, g.googAutoGainControl2 = i.audioProcessing.AGC)), 0 !== Object.keys(g).length && (!0 === c.audio ? c.audio = {
                                            mandatory: g
                            ...
                            if ((0, s.GetUserMedia)(v, function (t) {
                                    ...
                                    return v.video && !r && v.audio && !a ? (u.default.error("Media access: NO_CAMERA_MIC_PERMISSION"), o && o("NO_CAMERA_MIC_PERMISSION")) : v.video && !r ? (u.default.error("Media access: NO_CAMERA_PERMISSION"), o && o("NO_CAMERA_PERMISSION")) : v.screen && !r ? (u.default.error("Media access: NO_SCREEN_PERMISSION"), o && o("NO_SCREEN_PERMISSION")) : v.audio && !a ? (u.default.error("Media access: NO_MIC_PERMISSION"), o && o("NO_MIC_PERMISSION")) : (u.default.debug("User has granted access to local media"), i.dispatchEvent({
                                        type: "accessAllowed"
                                    }), i.stream = t, i.initialized = !0, n && n(), i.hasVideo() && (0, f.vsResHack)(t, function (e, t) {
                    ...
                    return u.default.debug("Enable audio stream with id", i.streamId), !(!i.hasAudio() || !i.initialized || void 0 === i.stream || !0 === i.stream.getAudioTracks()[0].enabled) && (void 0 !== i.unmuteAudio && i.unmuteAudio(), i.audioEnabled = !0, i.stream.getAudioTracks()[0].enabled = !0, !0)
                }, i.disableAudio = function () {
                    return u.default.debug("Disable audio stream with id", i.streamId), !!(i.hasAudio() && i.initialized && void 0 !== i.stream && i.stream.getAudioTracks()[0].enabled) && (void 0 !== i.muteAudio && i.muteAudio(), i.audioEnabled = !1, i.stream.getAudioTracks()[0].enabled = !1, i.sid && m.report.audioSendingStopped(i.sid, {
                        succ: !0,
                        reason: "muteAudio"
                    }), !0)
                }, i.enableVideo = function () {
                    return u.default.debug("Enable video stream with id", i.streamId), !(!i.initialized || void 0 === i.stream || !i.stream.getVideoTracks().length || !0 === i.stream.getVideoTracks()[0].enabled) && (void 0 !== i.unmuteVideo && i.unmuteVideo(), i.videoEnabled = !0, i.stream.getVideoTracks()[0].enabled = !0, i.lowStream && i.lowStream.enableVideo(), !0)
                }, i.disableVideo = function () {
                    return u.default.debug("Disable video stream with id", i.streamId), !!(i.initialized && void 0 !== i.stream && i.stream.getVideoTracks().length && i.stream.getVideoTracks()[0].enabled) && (void 0 !== i.muteVideo && i.muteVideo(), i.videoEnabled = !1, i.stream.getVideoTracks()[0].enabled = !1, i.lowStream && i.lowStream.disableVideo(), i.sid && m.report.videoSendingStopped(i.sid, {
                        succ: !0,
                        reason: "muteVideo"
                    }), !0)
                }, i.play = function (e, t) {
                    i.showing = !1, !i.local || i.video || i.screen ? void 0 !== e && (i.player = new a.default({
                        id: i.getId(),
                        stream: i,
                        elementID: e,
                        options: void 0,
        ...
        var i = n(1),
            ...
            o = function (e, t, n, i) {
                ...
                o.timeout = t.timeout || r.HTTP_CONNECT_TIMEOUT, o.open("POST", e, !0), o.setRequestHeader("Content-type", "application/json; charset=utf-8"), o.onload = function (e) {
                    n && n(o.responseText)
        ...
        var i = n(0),
            ...
            o = (n(4), function (e) {
                ...
                t.pc_config = {
                    ...
                    e.candidate ? t.iceCandidateCount += 1 : (r.default.debug("PeerConnection State: " + t.peerConnection.iceGatheringState), void 0 === t.ices && (t.ices = 0), t.ices = t.ices + 1, t.ices >= 1 && t.moreIceComing && (t.moreIceComing = !1, t.markActionNeeded()))
                };
                var i = function (t) {
                    var n, i;
        ...
        var i = n(0),
            ...
            a = function (e) {
                ...
                t.isSubscriber = e.isSubscriber, t.pc_config = {
                    ...
                    }, 1e3)), null === i && null === o && null === a || void 0 !== t.ice || (r.default.debug("srflx candidate : " + i + " relay candidate: " + a + " host candidate : " + o), clearTimeout(t.timeout), t.ice = 0, t.moreIceComing = !1, t.markActionNeeded()), t.iceCandidateCount = t.iceCandidateCount + 1
        ...
        var r = n(31),
            ...
            E = function (e) {
                var t = {};
                t.key = void 0, t.highStream = null, t.lowStream = null, t.lowStreamParameter = null, t.isDualStream = !1, t.highStreamState = 2, t.lowStreamState = 2, t.proxyServer = null, t.turnServer = {};
                ...
                return t.aespassword = null, t.aesmode = S.ENCRYPTION_MODE_NONE, t.setLowStreamParameter = function (e) {
                    ...
                    t.turnServer.url = r, t.turnServer.udpport = d, t.turnServer.username = o, t.turnServer.credential = a, t.turnServer.forceturn = c || !1, u && (t.turnServer.tcpport = u, s.default.info("Set turnserver tcpurl." + t.turnServer.url + ":" + t.turnServer.tcpport)), s.default.info("Set turnserver udpurl." + t.turnServer.url + ":" + t.turnServer.udpport + ",username:" + t.turnServer.uername + ",password:" + t.turnServer.credential)
                    ...
                    return "iOS" === (0, f.getBrowserOS)() ? (p.report.streamSwitch(e.sessionId, {
                        ...
                        isdual: !0,
                        succ: !0
                    }), t.isDualStream = !0, void(0 === t.highStreamState ? t._publishLowStream(n, function (e) {
                    ...
                    p.report.streamSwitch(e.sessionId, {
                        ...
                        isdual: !1,
                        succ: !0
                    }), t.isDualStream = !1, 0 === t.highStreamState ? t._unpublishLowStream(n, function (e) {
                    ...
                    t.gatewayClient.closeGateway(), t.gatewayClient.socket = void 0, t.gatewayClient.hasChangeBGPAddress = !0, t.joinInfo.multiIP = e.arg.option, (0, l.getGatewayList)(t.joinInfo, function (e) {
        ...
        var r = n(3),
            ...
            u = function (e) {
                ...
                return t.needReconnect = !0, t.isTimeout = !1, t.isInit = !0, t.hostIndex = 0, t.requestID = 0, e.host instanceof Array ? t.host = e.host : t.host = [e.host], t.getURL = function () {
                    return t.connection.url
                }, t.reconnect = function () {
                    t.isInit = !0, t.creatConnection()
                }, t.connectNext = function () {
                    t.isInit = !0, ++t.hostIndex, d.default.debug("Gateway length:" + t.host.length + " current index:" + t.hostIndex), t.hostIndex >= t.host.length ? t.dispatchEvent((0, r.MediaEvent)({
                        type: "recover"
                    })) : t.creatConnection()
                    ...
                    d.default.debug("start connect:" + t.host[t.hostIndex]), t.lts = (new Date).getTime(), t.connection = new WebSocket("wss://" + t.host[t.hostIndex]), t.connection.onopen = function (e) {
                        d.default.debug("websockect opened"), t.needReconnect = !0, t.isTimeout = !1, t.isInit = !1, clearTimeout(t.timeoutCheck), t.dispatchEvent((0, r.MediaEvent)({
                            type: "onopen",
                            event: e,
                            socket: t
                        }))
